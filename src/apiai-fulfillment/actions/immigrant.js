...
const swedishForImmigrants_1 = require("../data/swedishForImmigrants");
...
exports.getSwedishDirections = (difficulty) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    return swedishForImmigrants_1.default[difficulty];
});
//# sourceMappingURL=immigrant.js.map